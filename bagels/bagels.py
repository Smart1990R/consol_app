...
class Bagels:
    ...
    def __init__(self, num_digits=3, max_guesses=10):
        self.NUM_DIGITS = num_digits  # (!) Try setting this to 1 or 10.
        self.MAX_GUESSES = max_guesses  # (!) Try setting this to 1 or 100.
    ...
    def run(self):
        ...
        clues would be Fermi Pico.'''.format(self.NUM_DIGITS))
